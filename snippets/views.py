...
#
# @extend_schema(request=SnippetSerializer, responses=OpenApiTypes.STR)
# @api_view(['GET', 'POST'])
...
from snippets.utils import override
...
#         snippet = self.get_object(pk)
#         serializer = SnippetSerializer(instance=snippet, data=request.data, partial=True)
#         if serializer.is_valid():
#             serializer.save()
#             return Response(serializer.data)
#         return Response(serializer.errors, status = status.HTTP_400_BAD_REQUEST)
